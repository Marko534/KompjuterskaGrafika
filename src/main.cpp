...
int main() {
    ...
    glBindVertexArray(VAO);
    float numbOfRows= 8.0;
    float numbOfColumns = 8.0;
    numbOfColumns = numbOfColumns/4.0;
    numbOfRows = numbOfRows/4.0;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ourShader.use();
        ourShader.setFloat("numbOfRows", numbOfRows);
        ourShader.setFloat("numbOfColumns",numbOfColumns);
        glBindVertexArray(VAO);
